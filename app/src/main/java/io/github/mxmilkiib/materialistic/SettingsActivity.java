...
import io.github.mxmilkiib.materialistic.data.SearchRecentSuggestionsProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.drawer_display).setOnClickListener(v ->
                startActivity(new Intent(SettingsActivity.this, PreferencesActivity.class)
                        .putExtra(PreferencesActivity.EXTRA_TITLE, R.string.appearance)
                        .putExtra(PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_appearance)));
        ...
        findViewById(R.id.menu_list).setOnClickListener(v ->
                startActivity(new Intent(SettingsActivity.this, PreferencesActivity.class)
                        .putExtra(PreferencesActivity.EXTRA_TITLE, R.string.behaviour)
                        .putExtra(PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_behaviour)));
    }
